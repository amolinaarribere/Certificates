...
async function InitializeContracts(chairPerson, PublicOwners, minOwners, user_1, PublicPriceWei, PrivatePriceWei, OwnerRefundPriceWei){
    ...
    let treasury = await Treasury.new(PublicPriceWei, PrivatePriceWei, OwnerRefundPriceWei, publicPool.address, certPoolManager.address, {from: user_1});
