...
async function createElementWrong(FactoryProxy, Owners, minOwners, ElementName, Price, user_1){
    ...
    // act
    try{
        await FactoryProxy.methods.create(Owners, minOwners, ElementName).send({from: user_1, value: Price - 1, gas: Gas}, function(error, result){});
        expect.fail();
    }
    // assert
    catch(error){
    ...
    // act
     try{
        await FactoryProxy.methods.create(Owners, Owners.length + 1, ElementName).send({from: user_1, value: Price, gas: Gas}, function(error, result){});
        expect.fail();
    }
    // assert
    catch(error){
    ...
    // act
    try{
        await FactoryProxy.methods.create(Owners, 0, ElementName).send({from: user_1, value: Price, gas: Gas}, function(error, result){});
        expect.fail();
    }
    // assert
    catch(error){
    ...
    // act
    try{
        await FactoryProxy.methods.create(emptyOwners, 0, ElementName).send({from: user_1, value: Price, gas: Gas}, function(error, result){});
        expect.fail();
    }
    // assert
    catch(error){
...
async function createElementCorrect(FactoryProxy, Owners, minOwners, ElementName, Price, user_1, user_2, user_3){
    var total = await FactoryProxy.methods.retrieveTotal().call({from: user_1}, function(error, result){});
    expect(parseInt(total)).to.equal(0);
    await FactoryProxy.methods.create(Owners, minOwners, ElementName).send({from: user_1, value: Price, gas: Gas}, function(error, result){});
    await FactoryProxy.methods.create(Owners, minOwners, ElementName).send({from: user_2, value: Price, gas: Gas}, function(error, result){});
    await FactoryProxy.methods.create(Owners, minOwners, ElementName).send({from: user_3, value: Price, gas: Gas}, function(error, result){});
