...
contract("Testing Certificate Pool Manager",function(accounts){
    ...
    async function checkProxyAddresses( _ppa, _ta, _ca, _ppfa, _pfa, _pco, _ps){
    ...
    async function checkImplAddresses( _ppa, _ta, _ca, _ppfa, _prpa, _pfa, _pra, _pco, _ps, _ppcn, _ppcv){
    ...
    async function checkProposition( _ppa, _ta, _ca, _ppfa, _prpa, _pfa, _pra, _pco, _ps){
        var propositionResult = await certPoolManager.retrieveProposition({from: user_1});
        let {0: _publicAddress, 1: _treasuryAddress, 2: _certisAddress, 3: _privatePoolFactoryAddress, 4: _privatePoolAddress, 5: _providerFactoryAddress, 6: _providerAddress, 7: _priceConverterAddress, 8: _propositionSettingsAddress} = propositionResult;
    ...
    it("Retrieve Configuration",async function(){
        // assert
        await checkProxyAddresses(publicPoolProxy._address, treasuryProxy._address, certisTokenProxy._address, privatePoolFactoryProxy._address, providerFactoryProxy._address, priceConverterProxy._address, propositionSettingsProxy._address);
        await checkImplAddresses(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings, PrivatePoolContractName, PrivatePoolContractVersion);
    });

    it("Retrieve Proposals Details",async function(){
        // act
        await proposition.SplitTokenSupply(certisTokenProxy, tokenOwner, chairPerson);
        await certPoolManager.upgradeContracts(obj.returnUpgradeObject(address_1, address_2, address_3, address_4, address_5, address_6, address_7, address_8, address_9,
            emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyString, emptyString), {from: chairPerson, gas: Gas});
        // assert
        await checkProposition(address_1,address_2,address_3,address_4,address_5,address_6,address_7,address_8,address_9);
    ...
    it("Vote/Propose/Cancel Contracts Configuration WRONG",async function(){
        ...
        try{
            await certPoolManager.upgradeContracts(obj.returnUpgradeObject(address_1, address_2, address_3, address_4, address_5, address_6, address_7, address_8, address_9,
                emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyString, emptyString), {from: user_1, gas: Gas});
            expect.fail();
        }
        // assert
        catch(error){
        ...
        try{
            await certPoolManager.upgradeContracts(obj.returnUpgradeObject(address_1, address_2, address_3, address_4, address_5, address_6, address_7, address_8, address_9,
                emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyString, emptyString), {from: tokenOwner[0], gas: Gas});
            expect.fail();
        }
        // assert
        catch(error){
    ...
    it("Vote/Propose/Cancel Contracts Configuration CORRECT",async function(){
        ...
        await certPoolManager.upgradeContracts(obj.returnUpgradeObject(NewpublicPool, Newtreasury, NewcertisToken, NewprivatePoolFactory, NewprivatePool, NewproviderFactory, Newprovider, NewpriceConverter, NewpropositionSettings,
            emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, NewPrivatePoolContractName, NewPrivatePoolContractVersion), {from: chairPerson, gas: Gas});
        await checkImplAddresses(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings, PrivatePoolContractName, PrivatePoolContractVersion);
        await certPoolManager.voteProposition(false, {from: tokenOwner[0], gas: Gas});
        await checkImplAddresses(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings, PrivatePoolContractName, PrivatePoolContractVersion);
        await certPoolManager.voteProposition(false, {from: tokenOwner[1], gas: Gas});
        ...
        await certPoolManager.upgradeContracts(obj.returnUpgradeObject(address_0, address_0, address_0, address_0, address_0, address_0, address_0, address_0, address_0,
            emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyString, emptyString), {from: chairPerson, gas: Gas});
        await checkImplAddresses(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings, PrivatePoolContractName, PrivatePoolContractVersion);
        await certPoolManager.voteProposition(true, {from: tokenOwner[0], gas: Gas});
        await checkImplAddresses(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings, PrivatePoolContractName, PrivatePoolContractVersion);
        ...
        await checkImplAddresses(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings, PrivatePoolContractName, PrivatePoolContractVersion);
        await certPoolManager.voteProposition(true, {from: tokenOwner[2], gas: Gas});
        await checkImplAddresses(NewpublicPool, Newtreasury, NewcertisToken, NewprivatePoolFactory, NewprivatePool, NewproviderFactory, Newprovider, NewpriceConverter, NewpropositionSettings, NewPrivatePoolContractName, NewPrivatePoolContractVersion);

        // Rollback to original contracts
        await certPoolManager.upgradeContracts(obj.returnUpgradeObject(publicPool, treasury, certisToken, privatePoolFactory, privatePool, providerFactory, provider, priceConverter, propositionSettings,
            emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, PrivatePoolContractName, PrivatePoolContractVersion), {from: chairPerson, gas: Gas});
        await checkImplAddresses(NewpublicPool, Newtreasury, NewcertisToken, NewprivatePoolFactory, NewprivatePool, NewproviderFactory, Newprovider, NewpriceConverter, NewpropositionSettings, NewPrivatePoolContractName, NewPrivatePoolContractVersion);
        await certPoolManager.voteProposition(false, {from: tokenOwner[0], gas: Gas});
        await checkImplAddresses(NewpublicPool, Newtreasury, NewcertisToken, NewprivatePoolFactory, NewprivatePool, NewproviderFactory, Newprovider, NewpriceConverter, NewpropositionSettings, NewPrivatePoolContractName, NewPrivatePoolContractVersion);
        await certPoolManager.voteProposition(true, {from: tokenOwner[1], gas: Gas});
