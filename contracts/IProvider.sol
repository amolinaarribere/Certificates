 ...
 */
 ...
 interface IProvider  {
    ...
    function removeCertificate(address pool, uint256 CertificateId, address holder, bool poolPrivate) external;
    function updateCertificate(address pool, uint256 CertificateId, address holder, bytes memory CertificateHash, bool poolPrivate) external;
