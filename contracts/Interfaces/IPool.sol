 ...
 */
 ...
 interface IPool  {
    ...
    function addCertificateOnBehalfOf(address provider, bytes32 CertificateHash, address holder, uint256 deadline, bytes memory signature) external payable;
    ...
    function retrieveNonce(address provider) external view returns(uint256);
